Attribute VB_Name = "alphabetical_workbook"
Sub alphabetical_workbook()
...
'To select last row and make sure it counts last value
For I = 2 To LR
    ...
    If ws.Cells(I + 1, 1).Value <> ws.Cells(I, 1).Value Then
        ...
        'percent change formula and formatting number
    ...
    Else
        ' adding total value when ticker changes
        tickervolume = tickervolume + ws.Cells(I, 7).Value
    ...
    ' To find max and min increase and max totalvalue
